(function (window) {
	...
	function SpaceRock(size) {
		var img = ["1.png","2.png","3.png", "4.png", "5.png", "6.png", "7.png", "8.png", "9.png"];
		var choose = img[Math.floor(Math.random() * img.length)];
		
		this.Bitmap_constructor(choose); // super call
...
*/
	...
	p.activate = function (size) {
		...
		this.scaleX = size / 350 * 2;
		this.scaleY = size / 350 * 2;
	...
	window.SpaceRock = createjs.promote(SpaceRock, "Bitmap");
