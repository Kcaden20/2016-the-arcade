(function() {
	...
	var charHeight = 10;
	var letters = "Design";
	var likelihoodOfReplacingWord = 1;
	var words = ["Storyteller ", " Writer ", " Creator ", " Author ", " Disruptor ", " Hacker ", " Researcher " , "Creative" , "Commercial Artist" , " Visual Communicator " , " Communications " , " Conventional ", " Brandologist ", " Designologist "," Typologist " , " Interfaceologist ", " Specialist " , " Director ", " Curator ", " Translator ", " Intepretor ", " Intervenor ", " Brand ", " Art "];
	var likelihoodOfChangingExistingText = .005;
